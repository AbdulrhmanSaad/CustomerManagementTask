...
//    public class CustomersIntegrationTest:TestBase
//    {
//        private const string BaseUrl = "https://localhost:7120";
//        private readonly WebApplicationFactory<IAssmblyMarker> factory;
//        private readonly IUserTokenMangerService userTokenManger;
//        private readonly string DefaultTenantId = "SharedTenant";
//        private readonly string DefaultApiVersioning = "1";


//        public CustomersIntegrationTest(WebApplicationFactory<IAssmblyMarker> factory, IUserTokenMangerService userTokenManger) : base(factory, userTokenManger)
//        {
//            this.factory= factory;
//            this.userTokenManger = userTokenManger;
//        }
...
//            // Act
//            var result = await CreateApiClient().CustomerAllAsync(DefaultApiVersioning, DefaultTenantId);
